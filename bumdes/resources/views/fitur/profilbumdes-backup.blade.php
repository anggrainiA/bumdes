                                    ...
                                    <div class="row mt-5">
                                        ...
                                        <div class="mx-auto text-left">
                                            <form style="padding-right: 25px" method="POST"
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleFormControlInput1">Nomor Telepon Ketua
                                                        BUMDes</label>
                                                    <input type="text" class="form-control" name="no_ketua"
                                                        value="{{ $ketua->kontak }}">
                                                    {{-- <input type="hidden" class="form-control" name="id_ketua"
                                                        value="{{ $ketua[0]->id }}"> --}}
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    {{-- <input type="hidden" class="form-control" name="id_bendahara"
                                                        value="{{ $bendahara->kontak }}"> --}}
                                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form" action="{{ route('usaha.store') }}" method="post">
                        @csrf
    ...
    <div id="editjasa" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form" action="" method="post" id="urljasa">
                        @method('put')
                        @csrf
                        <div class="form-group">
                            <label class="col-md-4 control-label">Nama Usaha</label>
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label">Lokasi Usaha</label>
                            <div class="col-md-8">
                                <input name="lokasi" type="text" class="form-control" id="lokasijasa"
                                    placeholder="Alamat atau Lokasi Usaha" required />
                            </div>
                        </div>
    ...
    <div id="editdagang" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form" action="" method="post" id="urldagang">
                        @method('put')
                        @csrf
                        <div class="form-group">
                            <label class="col-md-4 control-label">Nama Usaha</label>
                            <div class="col-md-8">
                                <input name="nama" type="text" class="form-control" id="namadagang"
                                    placeholder="Nama Usaha atau Perusahaan" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label">Lokasi Usaha</label>
                            <div class="col-md-8">
                                <input name="lokasi" type="text" class="form-control" id="lokasidagang"
                                    placeholder="Alamat atau Lokasi Usaha" required />
                            </div>
                        </div>
