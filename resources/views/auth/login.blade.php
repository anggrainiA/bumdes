                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal m-t-20" action="{{route('authenticate')}}" method="Post">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" name="nama" type="text" placeholder="Nama Pengguna"  autoFocus required>
                            </div>
                        </div>

                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" name="password" type="password" placeholder="Kata Sandi"  required >
                            </div>
                        </div>
                        ...
                        <div class="form-group text-center m-t-20">
                            <div class="col-xs-12">
                                <button class="btn btn-primary w-md waves-effect waves-light" type="submit" onclick="">Masuk</button>
                            </div>
                        </div>
