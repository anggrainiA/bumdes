...
<div class="left side-menu">
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                <li>
                    <a href="{{route('dashboard')}}" class="waves-effect"><i class="ion-android-user-menu"></i><span> Dashboard </span></a>
                </li>
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{route('pemasok')}}">Pemasok</a></li>
                        <li><a href="{{route('pelanggan')}}">Pelanggan</a></li>
                        <li><a href="{{route('datahutang')}}">Data hutang</a></li>
